...
const Card = (props: CardProps) => {
  return (
    <Link
      className="m-2 min-w-fit transform overflow-hidden overflow-ellipsis rounded border shadow-lg transition duration-500 ease-in-out hover:-translate-y-1 hover:scale-105 hover:shadow-xl"
    ...
    >
      ...
      <div className="flex gap-2 border-t p-2">
        <Image
          ...
          alt="..."
        />
        <p className="max-h-56 overflow-clip overflow-ellipsis p-2">
          {props.synopsis}
        </p>
      </div>
    </Link>
